...
public class WithdrawWindow extends gamePanel implements ActionListener {
	...
	WithdrawWindow() {
		...
		body.setText("Enter withdraw amount: ");
		body.setFont(new Font("MV Boli",Font.PLAIN,23));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submit) {
			...
			textfield.getText();
			message.setText("Your withdraw of " + textfield.getText() + " dollars was successful!");
